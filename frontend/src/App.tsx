...
const SalesOrdersPage = lazy(() => import("./pages/SalesOrders").then((m) => ({ default: m.SalesOrdersPage })));
...
const InvoicePrintPage = lazy(() => import("./pages/InvoicePrint").then((m) => ({ default: m.InvoicePrintPage })));
      ...
      <Suspense fallback={<LoadingState label={false} />}>
        <Routes>
          ...
          <Route element={<RequireAuth />}>
            {/* Fatura yazdırma — tam ekran, sidebar yok */}
            <Route path="invoices/:orderId/:invoiceId/print" element={<InvoicePrintPage />} />
