...
class SalesRecord(Base):
    ...
    # nakit | kredi | banka_havalesi
    payment_type: Mapped[str] = mapped_column(String(24), nullable=False, default="nakit", server_default="nakit")
...
class SalesItem(Base):
    ...
    tax_rate: Mapped[Decimal] = mapped_column(Numeric(5, 2), nullable=False, default=Decimal("20.00"), server_default="20.00")
    tax_amount: Mapped[Decimal] = mapped_column(Numeric(14, 2), nullable=False, default=Decimal("0.00"), server_default="0")
    # Satış anındaki ürün maliyeti snapshot — geçmiş COGS doğruluğu için
    cost_price_snapshot: Mapped[Decimal] = mapped_column(Numeric(12, 2), nullable=False, default=Decimal("0.00"), server_default="0")
