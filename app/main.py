...
async def lifespan(app: FastAPI):
    ...
    from app.realtime.notification_ws_hub import spawn_anomaly_detection_task

    ws_anomaly_task = spawn_anomaly_detection_task()
...
def register_exception_handlers(app: FastAPI) -> None:
    ...
    async def handle_validation_exc(
        ...
        # jsonable_encoder: custom field_validator'ların ctx'indeki ValueError gibi
        # serileştirilemeyen nesneleri güvenli stringe çevirir (aksi halde 500 olur).
