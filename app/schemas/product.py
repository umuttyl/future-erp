...
class ProductBase(BaseModel):
    ...
    tax_rate: Decimal = Field(default=Decimal("20.00"), ge=0, le=100, description="KDV oranı (%)")
...
class StockAdjustRequest(BaseModel):
    ...
    unit_cost: Optional[Decimal] = Field(default=None, ge=0, description="Giriş birim maliyeti (yalnızca movement_type=in)")
